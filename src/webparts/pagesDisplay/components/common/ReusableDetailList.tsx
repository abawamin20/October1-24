...
> {
  ...
  componentDidUpdate(prevProps: any, prevState: any) {
    const { initialScrollTop } = this.props;
    const element = document.querySelector(".ms-DetailsList-contentWrapper");

    // Skip the update logic if the change is caused by _selection
    if (this._selectionChanged) {
      this._selectionChanged = false; // Reset the flag
      return; // Skip the rest of the logic
    }

    if (element) {
      element.setAttribute("data-is-scrollable", "true");
